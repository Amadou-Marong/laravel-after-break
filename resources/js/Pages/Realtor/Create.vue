    ...
    <form @submit.prevent="create">
      <div class="grid grid-cols-6 gap-4">
        ...
        <div class="col-span-6">
          ...
          <input class="border rounded-md file:px-4 file:py-2 border-gray-200 dark:border-gray-600 file:text-gray-600 file:dark:text-gray-300 file:border-0 file:dark:bg-gray-600 file:bg-gray-100 file:hover:bg-gray-200 file:dark:hover:bg-gray-500" type="file" @input="form.listing_image = $event.target.files[0]" name="listing_image"/>
